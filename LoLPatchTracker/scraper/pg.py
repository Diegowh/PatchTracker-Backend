...
class SeasonsScraper:
    ...
    def _find_seasons_ul(self):
        ...
        seasons_soup = soup("https://leagueoflegends.fandom.com/wiki/Patch_(League_of_Legends)")
...
class PatchesScraper(SeasonsScraper):
    def _patches_urls(self) -> list:
        ...
        for endpoint in endpoints:
            urls.append(url_generator("https://leagueoflegends.fandom.com/wiki/Patch_(League_of_Legends)", endpoint))
            
            pre_season_endpoint = endpoint + '#Pre' + endpoint.replace('/', '-')
            urls.append(url_generator("https://leagueoflegends.fandom.com/wiki/Patch_(League_of_Legends)", pre_season_endpoint))
...
scraper = LoLScraper()
print(scraper.all_seasons_data)